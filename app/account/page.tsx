  ...
  return (
    <DashboardLayout>
        ...
        <form action={updateAccount}>
          ...
          <div className="mb-4 ml-100">
            <label htmlFor="notificationEmail" className="block text-sm font-medium text-gray-700">Email Address for Notifications</label>
            <input type="email" id="notificationEmail" name="notificationEmail" defaultValue={user.user_metadata?.notification_email || ''} className="mt-1 block w-100 px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
          </div>
          ...
          <button type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Update Account</button>
        </form>
    </DashboardLayout>
  );
}