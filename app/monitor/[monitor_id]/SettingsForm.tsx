    ...
    <div className="rounded-2xl shadow-2xl bg-indigo-950 p-8 text-white m-10">
      ...
      <form action={formAction}>
        ...
        <div className="mb-4">
          ...
          <input type="number" id="checkFrequency" name="checkFrequency" defaultValue={monitor.check_frequency} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm bg-gray-800 text-white" />
        </div>
